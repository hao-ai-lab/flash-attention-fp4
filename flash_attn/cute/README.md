...
This document summarizes a debugging session investigating performance anomalies in a Blackwell FP4 quantized Flash Attention kernel. The kernel uses CuTe DSL and current has performance and precision issues. The perf issues are deep (at the SASS level).
